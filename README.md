...
## Я продвинутый системный инженер, преуспевающий аналитик данных, отстаиваю OpenSource. Люблю познавать новое в сфере ИТ, что наносит добро и причиняет пользу.
...
* 🎓 ФГБОУ ВО "Горный университет":
  ...
  - Магистр техники и технологии: 27.04.03 / 220100.68, Системный анализ и управление;
  - &#128213; Диплом с отличием &#128213;;
* Постигаю дао IT, до всего, что смогу дотянуться &#129304;
* Познаю Data Science с 2021 &#9996;
<!-- * В данный момент работаю над портфолио в Data Science проектах и ловлю хакатоны &#129327; -->
...
- Hard skills:
  * Основной опыт сейчас - сервера, сети, виртуализация, инфраструктура;
  * Математика, высшая математика, математическая статистика - получено в большом объёме ещё в университете, изучаю ML & DL на досуге;
  * Не знаю куда выведет "линия вайти-вайти", но пока чуйка тянет в DevOps;
...
## &#9889; В настоящее время
- Повышаю квалификацию в Linux, Ansible, Docker, K8s и втыкаю во всякое около-айтишное;
- Изучаю и тренируюсь на Stepik.org, Leetcode.com, Coursera.org, HackerRank.com, Hexlet.io и др.;
<br>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Matplotlib-2c576f.svg?style=for-the-badge&logo=Matplotlib&logoColor=black">&nbsp;&nbsp;
...
<p align="center">
  <img width="50%" src="https://github-readme-stats.vercel.app/api?username=yaroslav-vorobyov&theme=merko&show_icons=true&hide_border=false&border=FFFFFF"/>
</p>
